(function () {
	...
	app.controller('ClassificadoController', [
		'ClassificadosService', '$stateParams', 'Session', '$ionicHistory', 'appConfig', 'ToasterService',
		function (ClassificadosService, $stateParams, Session, $ionicHistory, appConfig, ToasterService) {
